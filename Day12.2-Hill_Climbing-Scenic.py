...
Record the ordinal values (shifted - 96) in the first place. End with '{' (123) as character after 'z'. At height 27: we've found one way to go.
...
for y in range(mheight):
    for x in range(mwidth):
        if m[y][x] == 1:
            nextstep(x, y, 1, 0)  # x, y, height, steps taken

print("Min steps:", minsteps)

# 478 for 12.2 (in 5.8s)
